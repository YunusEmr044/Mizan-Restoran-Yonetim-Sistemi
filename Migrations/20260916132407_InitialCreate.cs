        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClosingCountedAmount = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    OpenedByUserId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OpenedByUserName = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    HeroTitle = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    HeroSubtitle = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    HeroImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HeroPrimaryButtonText = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
                    HeroPrimaryButtonUrl = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    HeroSecondaryButtonText = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
                    HeroSecondaryButtonUrl = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    ...
                    ReservationEnabled = table.Column<bool>(type: "bit", nullable: false),
                    ThemePrimaryColor = table.Column<string>(type: "nvarchar(7)", maxLength: 7, nullable: false),
                    ThemeDarkColor = table.Column<string>(type: "nvarchar(7)", maxLength: 7, nullable: false),
                    ThemeBackgroundColor = table.Column<string>(type: "nvarchar(7)", maxLength: 7, nullable: false),
                    ThemeTextColor = table.Column<string>(type: "nvarchar(7)", maxLength: 7, nullable: false),
                    ThemeHeadingFont = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    ThemeBodyFont = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    ThemeCornerStyle = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    AdminAccentColor = table.Column<string>(type: "nvarchar(7)", maxLength: 7, nullable: false),
                    AdminSidebarColor = table.Column<string>(type: "nvarchar(7)", maxLength: 7, nullable: false),
                    AdminBackgroundColor = table.Column<string>(type: "nvarchar(7)", maxLength: 7, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentQuantity = table.Column<decimal>(type: "decimal(12,3)", nullable: false),
                    MinLevel = table.Column<decimal>(type: "decimal(12,3)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantityChange = table.Column<decimal>(type: "decimal(12,3)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Adisyonlar_RestaurantTables_TableId",
                        column: x => x.TableId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Feedbacks_RestaurantTables_TableId",
                        column: x => x.TableId,
                        principalTable: "RestaurantTables",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AdisyonId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DiscountRequests_Adisyonlar_AdisyonId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TableId = table.Column<int>(type: "int", nullable: false),
                    AdisyonId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Adisyonlar_AdisyonId",
                        column: x => x.AdisyonId,
                        principalTable: "Adisyonlar",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_Adisyonlar_AdisyonId",
                        column: x => x.AdisyonId,
                        principalTable: "Adisyonlar",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiscountRequests_AdisyonId",
                table: "DiscountRequests",
                column: "AdisyonId");

            migrationBuilder.CreateIndex(
                name: "IX_FeatureSettings_Key",
